...
const inviteCodes = [
  'T76ufOSQ3-p1EnGXWSDoPw==@ukOrmS0XIxYOtb34PN-8ww==@TvjO5k4gaVqVHMRJIogd_g==@xw5kwX7qy1ZmmSkfSXJeLw==',
  "T76ufOSQ3-p1EnGXWSDoPw==@ukOrmS0XIxYOtb34PN-8ww==@TvjO5k4gaVqVHMRJIogd_g==@xw5kwX7qy1ZmmSkfSXJeLw==",
...
async function joinLeaderTuan() {
  ...
  $.tuanIdS = null;
  if (!$.tuanIdS) await updateTuanIdsCDN('https://raw.githubusercontent.com/xingliuchao/jd/main/ShareCodes/jxgcT.json');
  if ($.tuanIdS && $.tuanIdS.tuanIds) {
    for (let tuanId of $.tuanIdS.tuanIds) {
      if (!tuanId) continue
      await JoinTuan(tuanId);
...
function updateTuanIds(url = 'https://raw.githubusercontent.com/xingliuchao/jd/main/ShareCodes/jxgcT.json') {
  return new Promise(resolve => {
...
function requireConfig() {
  return new Promise(async resolve => {
    await updateTuanIdsCDN('https://raw.githubusercontent.com/xingliuchao/jd/main/ShareCodes/jxgcT.json');
